...
Description: To study LORIS predictive power in merged Chowell et al. & MSK1 cohorts (Fig. 3, 4c,d; Extended Data Figs. 5, 6, 9, 13, 14c,d)
...
pdf(paste0(result_dir,"PanCancer_",cancer_type,'_',LLRmodelNA,"_TMB_PFScurve_",cutoffType,".pdf"), width = 5*0.8, height = 3.9*1.1, onefile = F) 
...
```{r}
cutoffType = 'PercentileCutoff' # 'AbsoluteCutoff'  'PercentileCutoff'
TMB_Percentile = 0.8 # 0.5   0.8
...
pdf(paste0(result_dir,"PanCancer_",cancer_type,'_',LLRmodelNA,"_TMB_OScurve_",cutoffType,".pdf"), width = 5*0.8, height = 3.9*1.1, onefile = F) 
...
ggpaired(PFSrate_score_6month %>% rename(`High` = PFSR_H,
         ...
         fill = "gray65",
         palette = my.cols, xlab = "Half year", legend.title = "Cancer type", ylab = "PFS probability") +
...
ggpaired(PFSrate_score_12month %>% rename(`High` = PFSR_H,
         ...
         cond1 = "High", cond2 = "Low", line.color = "CANCER_TYPE", line.size = 1,
         fill = "gray65",
         palette = my.cols, xlab = "One year", legend.title = "Cancer type", ylab = "PFS probability") +
  #stat_compare_means(paired = T, na.rm = TRUE) +
...
ggpaired(PFSrate_score_24month %>% rename(`High` = PFSR_H,
         ...
         cond1 = "High", cond2 = "Low", line.color = "CANCER_TYPE", line.size = 1,
         fill = "gray65",
         palette = my.cols, xlab = "Two years", legend.title = "Cancer type", ylab = "PFS probability") +
  #stat_compare_means(paired = T, na.rm = TRUE) +
  theme(legend.position = "none", axis.text.x = element_text(angle = 0, hjust = 0.5)) + # right
  ylim(0, 1) 
...
ggpaired(PFSrate_score_36month %>% rename(`High` = PFSR_H,
         ...
         cond1 = "High", cond2 = "Low", line.color = "CANCER_TYPE", line.size = 1,
         fill = "gray65",
         palette = my.cols, xlab = "Three years", legend.title = "Cancer type", ylab = "PFS probability") +
  #stat_compare_means(paired = T, na.rm = TRUE) +
  theme(legend.position = "none", axis.text.x = element_text(angle = 0, hjust = 0.5)) + # right
  ylim(0, 1) 
...
ggpaired(PFSrate_score_48month %>% rename(`High` = PFSR_H,
         ...
         cond1 = "High", cond2 = "Low", line.color = "CANCER_TYPE", line.size = 1,
         fill = "gray65",
         palette = my.cols, xlab = "Four years", legend.title = "Cancer type", ylab = "PFS probability") +
  #stat_compare_means(paired = T, na.rm = TRUE) +
  theme(legend.position = "none", axis.text.x = element_text(angle = 0, hjust = 0.5)) + # right
  ylim(0, 1) 
...
ggpaired(PFSrate_score_60month %>% rename(`High` = PFSR_H,
         ...
         cond1 = "High", cond2 = "Low", line.color = "CANCER_TYPE", line.size = 1,
         fill = "gray65",
         palette = my.cols, xlab = "Five years", legend.title = "Cancer type", ylab = "PFS probability") +
  #stat_compare_means(paired = T, na.rm = TRUE) +
  theme(legend.position = "none", axis.text.x = element_text(angle = 0, hjust = 0.5)) + # right
  ylim(0, 1) 
...
survp=ggsurvplot(
  ...
  palette = my.cols,# custom color palettes
  ...
  legend.title="",
  legend = c(0.4, 10.3), # legend relative position
