...
(Fig. 6d,e, Extended Data Fig. 10b,c, 11b,c)
###############################################################################################
...
pdf_file <- paste0(result_dir,paste0("pancohort_Forest_",survival_type,"_",HR_type,"_",Var_type,"_",testVAR0,".pdf"))
fig_width = 5
fig_height = 3
