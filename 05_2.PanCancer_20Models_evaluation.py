...
if __name__ == "__main__":
    ...
    MLM_list2=['LogisticRegression','GBoost', 'AdaBoost', 'HGBoost', 'XGBoost', 'CatBoost', 'LightGBM',
               ...
               'LLR6', 'LLR5noTMB', 'LLR5noChemo'] # StandardScaler (#18)
    MLM = sys.argv[1]
    if MLM in MLM_list1:
        SCALE = 'None'
    ...
    if MLM ==  'LLR6':
        featuresNA = ['TMB', 'Chemo_before_IO', 'Albumin', 'NLR', 'Age', 'CancerType1',
                      ...
                      'CancerType14', 'CancerType15', 'CancerType16']  ## 6 features
    elif MLM ==  'LLR5noChemo':
        featuresNA = ['TMB', 'Albumin', 'NLR', 'Age', 'CancerType1',
                      'CancerType2', 'CancerType3', 'CancerType4', 'CancerType5', 'CancerType6', 'CancerType7',
                      'CancerType8', 'CancerType9', 'CancerType10', 'CancerType11', 'CancerType12', 'CancerType13',
                      'CancerType14', 'CancerType15', 'CancerType16']  ## 5 features (withhout TMB)
    elif MLM ==  'LLR5noTMB':
    ...
    if MLM not in ['GaussianProcess','RF16_NBT','RF6', 'TMB']:
        if MLM in ['LLR6', 'LLR5noChemo', 'LLR5noTMB']:
            HyperParam_fnIn = '../03.Results/6features/PanCancer/ModelParaSearchResult_LLR6_Scaler(' + SCALE + ')_CV'+\
        ...
        param_dict = {'optimizer': [None], 'n_restarts_optimizer': [0], 'max_iter_predict': [100],
                      'kernel': [10 * kernels.RBF(length_scale=10)]} # 16 features
    ...
    if MLM not in ['RF16_NBT','RF6', 'TMB']:
        ...
        rf = RandomForestClassifier(random_state=randomSeed, n_jobs=8)
        search_cv = RandomizedSearchCV(estimator=rf, param_distributions=param_dict, n_iter=randomSearchNumber,
                                       ...
                                       return_train_score=True, cv=Kfold_list, verbose=info_shown, n_jobs=8)
    ...
    if MLM in ['LLR6', 'LLR5noChemo', 'LLR5noTMB', 'RF6', 'TMB']:
