...
# load data 
```{r}
selected_cols = c("SAMPLE_ID","CancerType")
...
CancerTypes = unique(c(Chowell_df$CancerType, MSK_df$CancerType, Kato_df$CancerType, Pradat_info_df$CancerType))
...
pie_chart <- pie_chart +
  ...
  labs(x = "", y = "")
# Save figure
ggsave(paste0(result_dir,paste0("Figure1A_cancerType_piePlot_Chowell.pdf")), width = 1.8*1, height = 1.8*1) # width = 2.3, height = 2.7
...
pie_chart <- pie_chart +
  ...
  labs(x = "", y = "")
# Save figure
ggsave(paste0(result_dir,paste0("Figure1A_cancerType_piePlot_MSK.pdf")), width = 1.8*1, height = 1.8*1) # width = 2.3, height = 2.7
...
pie_chart <- pie_chart +
  ...
  labs(x = "", y = "")
# Save figure
ggsave(paste0(result_dir,paste0("Figure1A_cancerType_piePlot_Kato.pdf")), width = 1.8*1, height = 1.8*1) # width = 2.3, height = 2.7
...
pie_chart <- pie_chart +
  ...
  labs(x = "", y = "")
# Save figure
ggsave(paste0(result_dir,paste0("Figure1A_cancerType_piePlot_Pradat.pdf")), width = 1.8*1, height = 1.8*1) # width = 2.3, height = 2.7
