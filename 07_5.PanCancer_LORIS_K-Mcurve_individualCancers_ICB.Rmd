...
Description: To plot Kaplan-Meier curves of PFS/OS in individual cancers of merged MSK cohorts (Extended Data Figs. 7,8)
###############################################################################################
...
for (ct in CancerTypes){
  ...
  #png(file=paste(result_dir,title_str,".png",sep = ""),res=300,width=1100, height=900) # width=600, height=350
  pdf(paste(result_dir,title_str,".pdf",sep = ""),width=4, height=3)
