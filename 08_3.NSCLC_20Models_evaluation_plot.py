...
palette = sns.color_palette(cc.glasbey, n_colors=16) # tab10, deep, muted, pastel, bright, dark, and colorblind
...
MLM_list = ['LLR6','LLR5noTMB','LogisticRegression', 'TMB', 'RF6', 'DecisionTree', 'RandomForest', 'GBoost',
             'AdaBoost', 'HGBoost', 'XGBoost', 'LightGBM', 'SupportVectorMachineRadial',
             'kNearestNeighbourhood', 'DNN', 'NeuralNetwork1', 'NeuralNetwork2', 'NeuralNetwork3', 'NeuralNetwork4',
             'GaussianProcess'] # 'LogisticRegression', 'TMB', 'RF6', 'RF16_NBT',
...
MLM_list2=['LLR6', 'LLR5noTMB', 'LLR5noChemo', 'LogisticRegression','GBoost', 'AdaBoost', 'HGBoost','XGBoost','CatBoost',
           'LightGBM', 'SupportVectorMachineLinear','SupportVectorMachinePoly','SupportVectorMachineRadial',
           'kNearestNeighbourhood','DNN','NeuralNetwork1','NeuralNetwork2','NeuralNetwork3','NeuralNetwork4',
           'GaussianProcess','QuadraticDiscriminantAnalysis'] # StandardScaler (#18)
MLM_name_map = {'LLR6': 'LLR6', 'LLR5noTMB': 'LLR5noTMB', 'LLR5noChemo': 'LLR5noChemo',
                'LogisticRegression': 'LogisticRegression', 'XGBoost':'XGBoost',
...
for MLM in MLM_list:
    ...
    fnIn = '../03.Results/16features/NSCLC/NSCLC_'+dataset+'_ModelEvalResult_' + MLM + '_Scaler(' + SCALE + ')_CV' + str(Kfold) + 'Rep' + str(
    ...
    MLM_performance_dict[MLM] = [np.mean(temp_df['Performance_train']), np.mean(temp_df['Performance_test']),
                                 np.mean(temp_df['Performance_delta'])]
...
fnOut = '../03.Results/FigureS8_NSCLC_'+dataset+'_ModelPerformance_'+plot_train_test+'.png'
